...
bool isValidMove(Card played, Card topCard, Color activeColor) 
{
...
void drawCard(Player& p, Card deck[], int& deckSize) 
{
	p.hand[p.cardCount++] = deck[--deckSize];
}

void nextPlayer(int& currentPlayer, int direction, int playersCount) 
{
